...
layout: default
nav_order: 1
permalink: /documentation/using/metadata
---
...
more than one person to approve changes introduced by commits. "How?", you ask?
...
in Part 5), and other uses of attestations throughout gittuf.

## Daily Workflow

You do not manually manage every part of metadata described above. Instead,
gittuf provides several commands that you use.
...
## Next: Verifying with gittuf

Now that we've seen how gittuf metadata is created and used, let's see gittuf in
action by [Verifying with gittuf].

[gittuf design document]: https://github.com/gittuf/gittuf/blob/main/docs/design-document.md
[Verifying with gittuf]: /documentation/using/verifying
